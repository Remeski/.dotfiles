-- Polite yoink from https://github.com/Stringboom/nvim
local M = {}
...
-- =====================================================================
-- 4. Load external colors from 
-- =====================================================================
local function load_colors()
	local file = vim.fn.expand("~/.config/nvim/colors.lua")
...
function M.apply()
	...
	vim.api.nvim_set_hl(0, "DiffAdd", { fg = "#000000", bg = c.error })
